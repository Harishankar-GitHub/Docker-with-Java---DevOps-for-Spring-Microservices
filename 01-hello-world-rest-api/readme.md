...
- 'd' in the above command is used to run the container in detached mode.
  i.e., the container will be running but we can execute commands in the terminal.
- -i=interactive and -t=tty in the above command is used to execute commands against the running container.
...
- NOTE : If above command not working, use ["""java""", """-jar""", """/tmp/hello-world-rest-api.jar"""]
